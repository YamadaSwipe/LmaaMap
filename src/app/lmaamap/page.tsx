      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            {/* Logos - Deux marques côte à côte avec bouton accueil */}
            <div className="flex items-center gap-3">
              <Link href="/" className="text-xl font-bold bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent hover:from-blue-700 hover:to-green-700 transition-all">
                ← ParenteseYou
              </Link>
              <span className="text-gray-300 text-xl">|</span>
              <Link href="/lmaamap" className="text-2xl font-bold text-blue-600 hover:text-blue-700 transition-colors">
                LmaaMap
              </Link>
              <span className="text-gray-300 text-xl">|</span>
            ...
            <div className="md:hidden mt-4 pb-4 border-t border-gray-200">
              <div className="flex flex-col space-y-3 pt-4">
                <Link href="/" className="text-gray-700 hover:text-blue-600 font-medium">
                  ← Accueil ParenteseYou
                </Link>
                <Link href="/map" className="text-gray-700 hover:text-blue-600 font-medium">
                  Carte
                </Link>
                <Link href="/hebergement" className="text-gray-700 hover:text-green-600 font-medium">
                  GreenYou
                </Link>
